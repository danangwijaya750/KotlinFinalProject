...
@Parcelize
data class BookmarkTeam(
		val id:Int,val TeamId:String, val TeamName:String,val TeamDesc: String,val TeamBadge:String, val TeamStadium:String,val TeamYear:String
):Parcelable {
	companion object {
